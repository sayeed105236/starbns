...
<div class="alert alert-danger show mb-2" role="alert">Success</div>
<div>
...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        ...
        <div class="dropdown">
           <div class="text-center"> <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#walletaddmodal" class="btn btn-primary"><span class="w-5 h-5 flex items-center justify-center"> <i class="w-4 h-4" data-feather="plus"></i> </span></a> </div>

           @include('backend.modals.walletaddmodal')
        ...
        <table id="myTable" class="table table-report -mt-2">
            <thead>
                <tr>
                    ...
                    <th class="whitespace-nowrap">Wallet Id</th>
              ...
              @foreach($wallet as $row)
                <tr class="intro-x">
                    ...
                    <td>
                        ...
                        <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5">{{$row->wallet_id}}</div>
                    </td>
                    ...
                    <td class="table-report__action w-56">
                        <div class="flex justify-center items-center">
                            <a class="flex items-center mr-3" href="javascript:;" data-tw-toggle="modal" data-tw-target="#walleteditmodal{{$row->id}}"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
                            <a class="flex items-center text-danger" href="/admin/home/wallet-delete/{{$row->id}}" > <i data-feather="trash-2" class="w-4 h-4 mr-1"></i> Delete </a>
                            @include('backend.modals.walleteditmodal')
                        </div>
                    </td>
                </tr>
                @endforeach
